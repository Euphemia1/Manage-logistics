...
<section class="team" id="team">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="0" stroke-linecap="round" stroke-linejoin="round">
        <path d="M18.244 2.25h3.308l-7.227 8.26L21.61 21.75H14.913l-5.188-6.095L2.25 21.75H8.08L14.325 9.173 18.244 2.25zM3.75 3.205l-1.424 1.424 4.935 7.02L1.044 20.75H4.07L9.28 14.045l6.164 7.705H21.61L15.914 8.774 20.096 3.205h-3.308L10.254 10.9L5.454 3.205H3.75z"/>
    </svg>
</a>
