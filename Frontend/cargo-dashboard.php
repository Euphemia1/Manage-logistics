  ...
  <div class="main-content ml-64 p-4 transition-all">
    ...
    <div class="header bg-white shadow-md rounded-lg p-6 mb-6 flex justify-between items-center">
      ...
      <div class="user-info flex items-center">
        ...
        <span id="cargoOwnerName" class="ml-3 text-lg font-semibold text-gray-800">Cargo Owner</span>
      </div>
    </div>

    <!-- Settings Section -->
    <div id="settingsSection" class="card bg-white shadow-md rounded-lg p-6 mb-6 hidden">
      <h3 class="text-xl font-bold mb-4">Update Profile</h3>
      <form id="profileForm">
        <div class="form-group mb-4">
          <label for="profileImage" class="block text-gray-700 mb-2">Upload Profile Picture</label>
          <input type="file" id="profileImage" accept="image/*" class="w-full p-2 border rounded-lg">
        </div>
        <div class="form-group mb-4">
          <label for="ownerName" class="block text-gray-700 mb-2">Cargo Owner Name</label>
          <input type="text" id="ownerName" placeholder="Enter your name" class="w-full p-2 border rounded-lg">
        </div>
        <button type="submit" class="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 transition-colors">Update Profile</button>
      </form>
    </div>
