      ...
      <div class="overflow-x-auto table-container">
        <table class="min-w-full bg-white">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              <td class="py-3 px-4 text-sm text-gray-900">#TR-8890</td>
              ...
              <td class="py-3 px-4 text-sm text-gray-900">May 2, 2025</td>
              <td class="py-3 px-4 text-sm">
            ...
            <tr class="hover:bg-gray-50">
              <td class="py-3 px-4 text-sm text-gray-900">#TR-8888</td>
              <td class="py-3 px-4 text-sm text-gray-900">Fragile</td>
              <td class="py-3 px-4 text-sm text-gray-900">Nairobi</td>
              <td class="py-3 px-4 text-sm text-gray-900">Nakuru</td>
              <td class="py-3 px-4 text-sm text-gray-900">158 km</td>
              <td class="py-3 px-4 text-sm text-gray-900">Apr 25, 2025</td>
              <td class="py-3 px-4 text-sm">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  Completed
                </span>
            ...
            <tr class="hover:bg-gray-50">
              <td class="py-3 px-4 text-sm text-gray-900">#TR-8886</td>
              <td class="py-3 px-4 text-sm text-gray-900">Non-Perishable</td>
              <td class="py-3 px-4 text-sm text-gray-900">Nairobi</td>
              <td class="py-3 px-4 text-sm text-gray-900">Thika</td>
              <td class="py-3 px-4 text-sm text-gray-900">45 km</td>
              <td class="py-3 px-4 text-sm text-gray-900">Apr 18, 2025</td>
              <td class="py-3 px-4 text-sm">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  Completed
                </span>
            ...
            <tr class="hover:bg-gray-50">
              <td class="py-3 px-4 text-sm text-gray-900">#TR-8885</td>
              <td class="py-3 px-4 text-sm text-gray-900">Perishable</td>
              <td class="py-3 px-4 text-sm text-gray-900">Nakuru</td>
              <td class="py-3 px-4 text-sm text-gray-900">Nairobi</td>
              <td class="py-3 px-4 text-sm text-gray-900">158 km</td>
              <td class="py-3 px-4 text-sm text-gray-900">Apr 15, 2025</td>
              <td class="py-3 px-4 text-sm">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  Completed
                </span>
