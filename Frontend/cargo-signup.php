            ...
            <div class="text-center">
                ...
                <div class="mt-2">
                    <p class="text-sm text-gray-500">
                        Congratulations, $signup_name! Your account has been successfully created.
                    </p>
...
<head>
  ...
  <title>Nyamula Logistics - Cargo Owner Login</title>
  ...
  <div class="max-w-6xl w-full grid md:grid-cols-2 gap-8 items-center">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 md:p-10">
      <div class="mb-8 text-center">
        <h2 class="text-2xl font-bold text-gray-900 mb-2">Cargo Owner Login</h2>
        <p class="text-gray-600">Sign in to access your account</p>
      </div>

      <form action="../Backend/cargo-owner-login.php" method="POST" class="space-y-6">
        <div>
      ...
      <p class="mt-6 text-center text-gray-600">
        ...
        <a href="cargo-owner-signup.php" class="text-blue-600 hover:text-blue-700 font-medium">
          Sign up
        </a>
      </p>
    </div>
